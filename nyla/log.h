...
namespace nyla {
	...
	enum error_tag {
		...
		ERR_FILE_WITH_MAIN_FUNCTION_DOES_NOT_EXIST,
		ERR_FILE_WITH_MAIN_FUNCTION_EMPTY,
		...
		ERR_FUNCTION_MARKED_STARTUP_HAS_PARAMS,
		ERR_FUNCTION_MARKED_STARTUP_NOT_VOID_RETURN,
		ERR_CONSTRUCTOR_MARKED_STARTUP,
		
		// Analysis Errors
		ERR_CANNOT_FIND_IMPORT,
		ERR_CANNOT_IMPORT_SELF,
		...
		ERR_CIRCULAR_FIELDS,
		ERR_ACCESSING_FIELD_FROM_STATIC_CONTEXT,
		ERR_FIELD_NOT_VISIBLE,
		ERR_FUNCTION_NOT_VISIBLE,
		ERR_THIS_KEYWORD_EXPECTS_DOT_OP,
		ERR_CANNOT_USE_THIS_KEYWORD_IN_STATIC_CONTEXT,
		ERR_THIS_KEYWORD_MUST_COME_FIRST,
		ERR_ATTEMPT_TO_DEREFERENCE_NON_POINTER,
